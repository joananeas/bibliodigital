...
<body>
    ...
    <main>
        <!-- <img src="./media/sistema/favicon/bell.png" width="50" height="50"><br> -->
        ...
        <div class="login">
            ...
            <form>
                ...
                <input id="password" type="password" placeholder="c0ntrasenya"><a id="showHideHolder"
                    onclick="togglePassword()"><img id="showHide" src="./media/icons/hide.png" width="16"
                        height="16"></a><br>
